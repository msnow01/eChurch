...
function printAlert($type, $text) {
    $alert = "<br><div class='alert alert-dismissible fade show alert-".$type."'>".$text."<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button></div>";
    return $alert;
}
