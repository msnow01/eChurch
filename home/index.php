    ...
    <div class="container" data-aos="fade-in">
        <div class="row justify-content-around">
            <a href="<?php echo $dir; ?>video" class="col-md-3 shadow info-box">
                ...
                <p class="sm-font">Watch worship material.</p>
            ...
            <a href="<?php echo $dir; ?>audio" class="col-md-3 shadow info-box">
                ...
                <p class="sm-font">Listen to worship material.</p>
                <div class="btn btn-dark">Listen</div>
            </a>
            <?php if ($session_row['webexlive']){
                echo '<a href="'.$webex_link.'" target="_blank" class="shadow col-md-3 info-box">
