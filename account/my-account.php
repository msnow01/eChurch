...
if (isset($_POST['submitaccount'])) {
    ...
    if (!$name || !$email || !$city || !$country){
        $alert_message = printAlert('danger', 'Sorry, you must provide a name, email address, city and country.');
    } else {
        ...
        if (!mysqli_query($link,$query)){
            ...
            $alert_message = printAlert('success', 'Successfully updated!');
        }
    }
}
